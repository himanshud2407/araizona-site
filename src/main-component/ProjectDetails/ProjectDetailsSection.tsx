...
const ProjectDetailsSection: React.FC = () => {
    const projectMeta = [
        ...
        { icon: icon5, label: "client :", value: "Araizona" },
        ...
        <section className="project-details pb-90">
            <div className="container">
                ...
                <div className="single-item-image mb-75">
                    <img src={(img07 as any).src || (img07 as any)} alt="pimage" />
                </div>
                ...
                <ul className="project-meta ul_li_between mt-120">
                    {projectMeta.map((item, i) => (
                        <li key={i}>
                            <img src={(item.icon as any).src || (item.icon as any)} alt="icon" /> <span>{item.label}</span>{" "}
                            {item.value}
                        </li>
                    ))}
                </ul>
