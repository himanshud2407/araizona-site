...
const teamMembers = [
  {
    ...
    role: "CEO & Chairman at, Araizona",
    img: img09,
    big: true,
  },
  {
    name: "Lennox Gabriel",
    role: "Chief Operating Officer at, Araizona",
    img: img10,
    big: true,
  },
  {
                    ...
                    >
                      ...
                      >
                        <div className="xb-item--img">
                          <img src={(item.img as any).src || (item.img as any)} alt={item.name} />
                        </div>
                        ...
                        <div className="xb-bg">
                          <img src={((item.big ? bgLarge : bgSmall) as any).src || (item.big ? bgLarge : bgSmall)} alt="background" />
                        </div>
                      </div>
                    </div>
                  ))}
