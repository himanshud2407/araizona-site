...
const BlogSection: React.FC = () => {
  useEffect(() => {
    ...
    if (bgEl) {
      bgEl.style.backgroundImage = `url(${(blogBg as any).src || blogBg})`;
    }
  }, []);
        ...
        <div className="row mt-none-30">
          ...
          <div className="col-lg-4 mt-30">
            <div className="sec-title blog-sec-title mb-70">
              <span className="sub-title mb-15">Insights for the AI-First Organization</span>
              <h2 className="title">
                Insights for the AI-First Organization
              </h2>
            </div>
                  ...
                  <div className="xb-item--inner img-hove-effect xb-border">
                    <div className="xb-img">
                      {[...Array(4)].map((_, i) => (
                        <Link href="/blog-details" key={i}>
                          <img src={(img01 as any).src || img01} alt="blog" />
                        </Link>
                      ))}
                    </div>
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={(icon01 as any).src || icon01} alt="icon" /> ai business tips
                        </li>
                        <li>
                          <img src={(icon02 as any).src || icon02} alt="icon" /> March 24, 2025
                        </li>
                      </ul>
                      <h2 className="xb-item--title">
                        <Link href="/blog-details">
                          How Araizona SimpleSphere is simplifying organizational workflows and
                          driving growth — everything you need to know.
                        </Link>
                      </h2>
                    </div>
                  </div>
                ...
                <div className="xb-blog-item xb-small-blog-item wow fadeInUp" data-wow-delay="150ms" data-wow-duration="600ms">
                  <div className="xb-item--inner img-hove-effect xb-border">
                    <div className="xb-img">
                      {[...Array(4)].map((_, i) => (
                        <Link href="/blog-details" key={i}>
                          <img src={(img02 as any).src || img02} alt="blog" />
                        </Link>
                      ))}
                    </div>
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={(icon01 as any).src || icon01} alt="icon" /> chatbots tips
                        </li>
                        <li>
                          <img src={(icon02 as any).src || icon02} alt="icon" /> April 27, 2025
                        </li>
                      </ul>
                      <h2 className="xb-item--title">
                ...
                <div className="xb-blog-item xb-small-blog-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="600ms">
                  <div className="xb-item--inner img-hove-effect xb-border">
                    <div className="xb-img">
                      {[...Array(4)].map((_, i) => (
                        <Link href="/blog-details" key={i}>
                          <img src={(img03 as any).src || img03} alt="blog" />
                        </Link>
                      ))}
                    </div>
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={(icon01 as any).src || icon01} alt="icon" /> ai business
                        </li>
                        <li>
                          <img src={(icon02 as any).src || icon02} alt="icon" /> March 17, 2025
                        </li>
                      </ul>
                      <h2 className="xb-item--title">
