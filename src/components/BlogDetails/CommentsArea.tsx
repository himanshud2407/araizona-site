    ...
    <div className="comment_area mb-70">
      ...
      <ul className="comments_list unordered_list_block list-unstyled">
        ...
        <li>
          <div className="comment_item">
            <div className="comment_author_thumbnail">
              <img src={((avatar2 as any) as any).src || ((avatar2 as any) as any)} alt="Avatar" />
            </div>
          ...
          <ul className="comments_list unordered_list_block list-unstyled">
            <li>
              <div className="comment_item">
                <div className="comment_author_thumbnail">
                  <img src={((avatar3 as any) as any).src || ((avatar3 as any) as any)} alt="Avatar" />
                </div>
        ...
        <li>
          <div className="comment_item">
            <div className="comment_author_thumbnail">
              <img src={((avatar4 as any) as any).src || ((avatar4 as any) as any)} alt="Avatar" />
            </div>
