      ...
      <div className="row mt-none-30">
          ...
          <div className="xb-blog-item xb-small-blog-item">
            <div className="xb-item--inner img-hove-effect xb-border">
              <div className="xb-img">
                <Link href="/blog-details"><img src={((img02 as any) as any).src || ((img02 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img02 as any) as any).src || ((img02 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img02 as any) as any).src || ((img02 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img02 as any) as any).src || ((img02 as any) as any)} alt="bimage" /></Link>
              </div>
              ...
              <div className="xb-item--holder">
                <ul className="xb-item--meta list-unstyled ul_li">
                  <li>
                    <img src={((blogIcon01 as any) as any).src || ((blogIcon01 as any) as any)} alt="icon" />
                    chatbots tips
                  </li>
                  <li>
                    <img src={((blogIcon02 as any) as any).src || ((blogIcon02 as any) as any)} alt="icon" />
                    April 27, 2025
                  </li>
                </ul>
        ...
        <div className="col-lg-4 col-md-6 mt-30">
          <div className="xb-blog-item xb-small-blog-item">
            <div className="xb-item--inner img-hove-effect xb-border">
              <div className="xb-img">
                <Link href="/blog-details"><img src={((img03 as any) as any).src || ((img03 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img03 as any) as any).src || ((img03 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img03 as any) as any).src || ((img03 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img03 as any) as any).src || ((img03 as any) as any)} alt="bimage" /></Link>
              </div>
        ...
        <div className="col-lg-4 col-md-6 mt-30">
          <div className="xb-blog-item xb-small-blog-item">
            <div className="xb-item--inner img-hove-effect xb-border">
              <div className="xb-img">
                <Link href="/blog-details"><img src={((img12 as any) as any).src || ((img12 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img12 as any) as any).src || ((img12 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img12 as any) as any).src || ((img12 as any) as any)} alt="bimage" /></Link>
                <Link href="/blog-details"><img src={((img12 as any) as any).src || ((img12 as any) as any)} alt="bimage" /></Link>
              </div>
              ...
              <div className="xb-item--holder">
                ...
                <h2 className="xb-item--title border-effect-2">
                  <Link href="/blog-details">
                    How Araizona SimpleSphere is Simplifying the Future..
                  </Link>
                </h2>
              </div>
            </div>
