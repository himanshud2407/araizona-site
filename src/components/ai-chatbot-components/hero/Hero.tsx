...
const HeroSection: React.FC = () => {
  ...
  return (
    <section
      ...
      style={ { backgroundImage: `url(${(heroBg as any).src || heroBg})` } }
    >
        ...
        <div className="row">
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          ...
                          <stop offset="1" stopColor="#0A0E27" stopOpacity="0" />
                        </radialGradient>
                      </defs>
                    </svg>
                  </span>
          ...
          <div className="col-lg-6">
            <div className="hero-img-container">
              ...
              >
                <img src={((heroImg as any) as any).src || ((heroImg as any) as any)} alt="AI Chatbot" />
              </div>

              <div className="xb-text-left wow updown">
                <div className="img img--1">
                  <img src={((textImg1 as any) as any).src || ((textImg1 as any) as any)} alt="text-img1" />
                </div>
                <div className="img img--2">
                  <img src={((textImg2 as any) as any).src || ((textImg2 as any) as any)} alt="text-img2" />
                </div>
              </div>

              <div className="xb-glassy-effect-img wow">
                <img src={((glassyEffect as any) as any).src || ((glassyEffect as any) as any)} alt="Glassy Effect" />
              </div>

              <div className="xb-text-right wow updown">
                <div className="img img--1">
                  <img src={((textImg3 as any) as any).src || ((textImg3 as any) as any)} alt="text-img3" />
                </div>
                <div className="img img--2">
                  <img src={((textImg4 as any) as any).src || ((textImg4 as any) as any)} alt="text-img4" />
                </div>
                <div className="img img--3">
                  <img src={((textImg5 as any) as any).src || ((textImg5 as any) as any)} alt="text-img5" />
                </div>
              </div>
            </div>
          </div>
