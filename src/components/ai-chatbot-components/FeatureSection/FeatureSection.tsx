...
const FeatureSection: React.FC = () => {
  return (
    <div
      className="bg_img"
      style={{
        backgroundImage: `url(${(bgImg as any).src || bgImg})`,
        ...
        <div className="container">
          <div className="sec-title sec-title--two custom-sec-title feature-sec-title text-center mb-45">
            <span className="sub-title">
              <img src={((subLeftIcon as any) as any).src || ((subLeftIcon as any) as any)} alt="icon" /> Araizona AI Chatbot Features
            </span>
            <h2 className="title">
              <span>
                <img src={((aiGif as any) as any).src || ((aiGif as any) as any)} alt="AI Animation" />
              </span>
          ...
          <div className="row mt-none-30">
              ...
              <div className="xb-feature-item-3 big-item">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <img src={((featureImg01 as any) as any).src || ((featureImg01 as any) as any)} alt="Automate feature" />
                    <span className="logo">
                      <img src={((featureLogo as any) as any).src || ((featureLogo as any) as any)} alt="logo" />
                    </span>
                  </div>
            ...
            <div className="col-lg-4 col-md-6 mt-30 order-lg-first">
              <div className="xb-feature-item-3">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <img src={((featureImg02 as any) as any).src || ((featureImg02 as any) as any)} alt="Sync Data" />
                    <span className="scan-img updown-2">
                      <img src={((scanImg as any) as any).src || ((scanImg as any) as any)} alt="scan" />
                    </span>
                  </div>
                  <div className="xb-item--holder">
            ...
            <div className="col-lg-4 col-md-6 mt-30">
              <div className="xb-feature-item-3">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <img src={((featureImg03 as any) as any).src || ((featureImg03 as any) as any)} alt="Multilingual" />
                    <span className="circle">
                      <img src={((circleImg as any) as any).src || ((circleImg as any) as any)} alt="circle" />
                    </span>
                  </div>
                  <div className="xb-item--holder">
            ...
            <div className="col-lg-4 col-md-6 mt-30">
              <div className="xb-feature-item-3">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <img src={((featureImg04 as any) as any).src || ((featureImg04 as any) as any)} alt="Advanced Reporting" />
                  </div>
                  <div className="xb-item--holder">
            ...
            <div className="col-lg-4 col-md-6 mt-30">
              <div className="xb-feature-item-3">
                <div className="xb-item--inner xb-border">
                  <div className="xb-img">
                    <img src={((featureImg05 as any) as any).src || ((featureImg05 as any) as any)} alt="Security" />
                    <span className="security">
                      <img src={((securityImg as any) as any).src || ((securityImg as any) as any)} alt="security" />
                    </span>
