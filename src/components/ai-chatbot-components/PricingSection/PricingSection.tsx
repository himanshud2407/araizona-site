      ...
      <div className="container">
        ...
        <div className="sec-title sec-title--two pricing-sec-title text-center mb-30">
          <span className="sub-title wow fadeInUp" data-wow-duration="600ms">
            <img src={((iconLeft as any) as any).src || ((iconLeft as any) as any)} alt="icon" /> Pricing Plans{" "}
            <img src={((iconRight as any) as any).src || ((iconRight as any) as any)} alt="icon" />
          </span>
          <h2
          ...
          >
            Simple & <img src={((moneyGif as any) as any).src || ((moneyGif as any) as any)} alt="shape" /> flexible pricing
          </h2>
        </div>
        ...
        <div className="row mt-none-30">
          ...
          <div className="col-lg-5 mt-30">
            <div
              ...
              data-wow-duration="600ms"
              style={{ backgroundImage: `url(${(bgItemImg as any).src || bgItemImg})` }}
            >
              <div className="xb-icon">
                <img src={((icon1 as any) as any).src || ((icon1 as any) as any)} alt="icon" />
              </div>
          ...
          <div className="col-lg-7 mt-30">
            ...
            >
              <div className="xb-icon">
                <img src={((icon2 as any) as any).src || ((icon2 as any) as any)} alt="icon" />
              </div>
