...
const TestimonialSection: React.FC = () => {
  return (
    <section
      ...
      style={ { backgroundImage: `url(${(bgImg as any).src || bgImg})` } }
    >
      <div className="container">
        <div className="sec-title sec-title--two tes-sec-title text-center mb-50">
          ...
          >
            <img src={((subLeftWhiteIcon as any) as any).src || ((subLeftWhiteIcon as any) as any)} alt="icon" /> Testimonials{" "}
            <img src={((subRightWhiteIcon as any) as any).src || ((subRightWhiteIcon as any) as any)} alt="icon" />
          </span>
          <h2
            ...
            data-wow-duration="600ms"
          >
            Hear from our <img src={((animatedGif as any) as any).src || ((animatedGif as any) as any)} alt="shape" /> happy customers
          </h2>
        </div>
      </div>
      ...
      <div className="testimonial-wrapper">
        ...
        >
          ...
          <SwiperSlide>
            <div className="ac-testimonial-item ul_li xb-border">
              <div className="xb-item--avatar">
                <img src={((author1 as any) as any).src || ((author1 as any) as any)} alt="Priya Ramirez" />
              </div>
              <div className="xb-item--holder">
                <p className="xb-item--content">
                  "Araizona now automates over 70% of our customer queries,
              ...
              <div className="xb-item--quote">
                <img src={((quoteIcon as any) as any).src || ((quoteIcon as any) as any)} alt="quote" />
              </div>
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="ac-testimonial-item ul_li xb-border">
              <div className="xb-item--avatar">
                <img src={((author2 as any) as any).src || ((author2 as any) as any)} alt="Sebastian Clark" />
              </div>
              <div className="xb-item--holder">
                <p className="xb-item--content">
                  "We launched Araizona in just minutes, and the impact was
          ...
          <SwiperSlide>
            <div className="ac-testimonial-item ul_li xb-border">
              <div className="xb-item--avatar">
                <img src={((author3 as any) as any).src || ((author3 as any) as any)} alt="Miguel Torres" />
              </div>
              <div className="xb-item--holder">
                <p className="xb-item--content">
                  "Araizona’s powerful analytics give us deep insights into
