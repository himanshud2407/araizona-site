...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "The setup is instant — once you provide your URL, Araizona begins training automatically. Within minutes, your chatbot is ready to answer real customer queries and continuously improve as it learns.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answer:
      "Yes! Araizona supports 90+ languages, allowing your chatbot to communicate with customers globally in their preferred language.",
  },
  {
    id: 5,
...
const FAQSection: React.FC = () => {
  ...
  return (
    <section
      ...
      style={ { backgroundImage: `url(${(faqBg as any).src || faqBg})` } }
    >
      <div className="container">
        ...
        <div className="sec-title sec-title--two pricing-sec-title text-center mb-50">
          ...
          >
            <img src={((subLeftIcon as any) as any).src || ((subLeftIcon as any) as any)} alt="icon" /> FAQ’s{" "}
            <img src={((subRightIcon as any) as any).src || ((subRightIcon as any) as any)} alt="icon" />
          </span>
          <h2
            ...
            <div className="xb-faq wow fadeInUp" data-wow-duration="600ms">
              <ul className="accordion_box clearfix list-unstyled">
                {faqs.map((faq, index) => (
                  <li
                    key={faq.id}
                    className={`accordion block ${activeId === faq.id ? "active-block" : ""
                      }`}
                  >
                    {/* Question Button */}
                    <div
                    ...
                    {/* Answer Body */}
                    <div
                      className={`acc_body ${activeId === faq.id ? "current" : ""
                        }`}
                      style={{
