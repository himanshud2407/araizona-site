            ...
            >
              ...
              <div className="sec-title sec-title--two process-title mb-50">
                <span className="sub-title d-block mb-25">
                  <img src={((subLeftIcon as any) as any).src || ((subLeftIcon as any) as any)} alt="icon" />
                  How It Works
                </span>
              ...
              <div className="xb-process-step xb-border active">
                <div className="xb-img">
                  <img src={((processImg01 as any) as any).src || ((processImg01 as any) as any)} alt="Step 1" />
              ...
              <div className="xb-process-step xb-border">
                <div className="xb-img">
                  <img src={((processImg01 as any) as any).src || ((processImg01 as any) as any)} alt="Step 2" />
              ...
              <div className="xb-process-step xb-border">
                <div className="xb-img">
                  <img src={((processImg01 as any) as any).src || ((processImg01 as any) as any)} alt="Step 3" />
          ...
          <div className="col-lg-7">
            ...
            >
              <div className="xb-process-item mt-30">
                <div className="xb-img">
                  <img src={((processImg02 as any) as any).src || ((processImg02 as any) as any)} alt="Process 1" />
                </div>
              </div>
              <div className="xb-process-item mt-30">
                <div className="xb-img">
                  <img src={((processImg03 as any) as any).src || ((processImg03 as any) as any)} alt="Process 2" />
                </div>
              </div>
              <div className="xb-process-item mt-30">
                <div className="xb-img">
                  <img src={((processImg04 as any) as any).src || ((processImg04 as any) as any)} alt="Process 3" />
                </div>
              </div>
            </div>
          </div>
