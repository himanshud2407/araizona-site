...
const ComparisonSection: React.FC = () => {
  const comparisons: ComparisonItem[] = [
    {
      title: "Without Araizona AI chatbot",
      icon: "❌",
      points: [
    ...
    {
      title: "With Araizona AI chatbot",
      icon: "✅",
      points: [
      ...
      <div className="row mt-none-30">
        {comparisons.map((block, index) => (
          <div className="col-lg-6 mt-30" key={index}>
            <div
              className={`comparison-list xb-border bg_img ${index === 0 ? "comparison--without" : "comparison--with"
                }`}
              style={ { backgroundImage: `url(${(comparisonBg as any).src || comparisonBg})` } }
            >
