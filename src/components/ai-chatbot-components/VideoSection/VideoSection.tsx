        ...
        <section className="video z-1 pt-25 pb-70 pos-rel">
            <div className="container">
                <div className="xb-video-frame pos-rel">
                    <div className="xb-img">
                        <img src={(((videoFrame as any) as any) as any).src || (((videoFrame as any) as any) as any)} alt="video frame" />
                    </div>
                        ...
                        <ul className="xb-video-nav nav nav-pills mb-3" role="tablist">
                            {tabs.map((tab, index) => (
                                <li className="nav-item xb-video-nav-item" key={tab.id}>
                                    ...
                                    >
                                        <img src={((tab.icon as any) as any).src || ((tab.icon as any) as any)} alt={`${tab.label} icon`} />
                                        {tab.label}
                                    </button>
                                </li>
                            ))}
                            ...
                            {tabs.map((tab, index) => (
                                ...
                                >
                                    <div className="xb-tab-img">
                                        <img src={((tab.img as any) as any).src || ((tab.img as any) as any)} alt={`${tab.label} preview`} />
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="xb-video-shape">
                        <div className="shape shape--1">
                            <img src={(((shape1 as any) as any) as any).src || (((shape1 as any) as any) as any)} alt="shape" />
                        </div>
                        <div className="shape shape--2 updown-2">
                            <img src={(((shape2 as any) as any) as any).src || (((shape2 as any) as any) as any)} alt="shape" />
                        </div>
                        <div className="shape shape--3 zoominup">
                            <img src={(((shape3 as any) as any) as any).src || (((shape3 as any) as any) as any)} alt="shape" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="xb-linear-gradient">
                ...
                <span className="gradient gradient--dot-img">
                    <img src={(((shape4 as any) as any) as any).src || (((shape4 as any) as any) as any)} alt="dot shape" />
                </span>
            </div>
            ...
            >
                <div className="xb-text-marquee-item">
                    ...
                    <span className="img">
                        <img src={(((robotImg as any) as any) as any).src || (((robotImg as any) as any) as any)} alt="robot" />
                    </span>
