    ...
    return (
        ...
        >
                ...
                <div className="container">
                    <div className="pos-rel z-1">
                        ...
                        <div className="xb-copyright ul_li_between">
                            <p>
                                Copyright © 2025 <Link href="/ai-chatbot">Araizona</Link>, All rights reserved.
                            </p>
            ...
            <div className="xb-footer-bottom-title wow fadeInUp" data-wow-duration="600ms">
                <h2 className="title">
                    Araizona AI <span>chatbot</span>
                    <img src={((diamondIcon as any) as any).src || ((diamondIcon as any) as any)} alt="icon" />
                </h2>
            </div>
