          ...
          <div className="col-lg-9 col-md-9">
            <div className="hero-content">
              <h2 className="title scale-animation wow">
                The AI Operating System for Modern Organizations
              </h2>
              <p className="sub-title scale-animation wow">
                Araizona SimpleSphere unifies student management, team
                operations, healthcare workflows, and enterprise automation —
                into one intelligent platform built for scale.
              </p>
