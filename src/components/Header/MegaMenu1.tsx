                  ...
                  <div className="megamenu_pages_wrapper">
                    <div className="row g-10">
                      <div className="col-xl-4 col-lg-4">
                        <Link className="iconbox_block_2" href="/products">
                          <span className="icon_title_wrap">
                            <small className="iconbox_icon">
                              <img src={((icon1 as any) as any).src || ((icon1 as any) as any)} alt="Service Icon" />
                            </small>
                            <small className="iconbox_title">Products</small>
                          </span>
                      ...
                      <div className="col-xl-4 col-lg-4">
                        ...
                        >
                          <span className="icon_title_wrap">
                            <small className="iconbox_icon">
                              <img src={((icon1 as any) as any).src || ((icon1 as any) as any)} alt="Service Details Icon" />
                            </small>
                        ...
                        <Link className="iconbox_block_2" href="/career">
                          <span className="icon_title_wrap">
                            <span className="iconbox_icon">
                              <img src={((icon3 as any) as any).src || ((icon3 as any) as any)} alt="Career Icon" />
                            </span>
                      ...
                      <div className="col-xl-4 col-lg-4">
                        <Link className="iconbox_block_2" href="/career-details">
                          <span className="icon_title_wrap">
                            <span className="iconbox_icon">
                              <img src={((icon2 as any) as any).src || ((icon2 as any) as any)} alt="Career Details Icon" />
                            </span>
                            <small className="iconbox_title">
                              Career details
                            </small>
                      ...
                      <div className="col-xl-4 col-lg-4">
                        <Link className="iconbox_block_2" href="/project">
                          <span className="icon_title_wrap">
                            <span className="iconbox_icon">
                              <img src={((icon3 as any) as any).src || ((icon3 as any) as any)} alt="Project Icon" />
                            </span>
                            <small className="iconbox_title">Our Products</small>
                          </span>
                          <span className="description mb-0">
                      ...
                      <div className="col-xl-4 col-lg-4">
                        <Link className="iconbox_block_2" href="/project-details">
                          <span className="icon_title_wrap">
                            <span className="iconbox_icon">
                              <img src={((icon3 as any) as any).src || ((icon3 as any) as any)} alt="Project Details Icon" />
                            </span>
                            <small className="iconbox_title">
                              Project details
                            </small>
                      ...
                      <div className="col-xl-4 col-lg-4">
                        <Link className="iconbox_block_2" href="/team">
                          <span className="icon_title_wrap">
                            <span className="iconbox_icon">
                              <img src={((icon4 as any) as any).src || ((icon4 as any) as any)} alt="Team Icon" />
                            </span>
                    ...
                    <ul className="btns_group mt-80 p-0 ul_li_between">
                      ...
                      <li>
                        <div className="review_short_info_2">
                          <div className="review_admin_logo">
                            <img src={((client1 as any) as any).src || ((client1 as any) as any)} alt="Client 1" />
                          </div>
                      ...
                      <li>
                        <div className="review_short_info_2">
                          <div className="review_admin_logo">
                            <img src={((client2 as any) as any).src || ((client2 as any) as any)} alt="Client 2" />
                          </div>
                          <div className="review_info_content">
                            <ul className="rating_block unordered_list">
                              {Array(5)
                  ...
                  <div className="mega_menu_left">
                    <div className="author_box">
                      <div className="author_image">
                        <img src={(robot as any).src || robot} alt="AI Robot" />
                      </div>
                    ...
                    <div className="author_box">
                      <div className="author_image">
                        <img src={(avatar as any).src || avatar} alt="CEO Avatar" />
                      </div>
                      <div className="author_box_content">
                        ...
                        <div className="author_holder">
                          ...
                          <span className="author_designation text-white">
                            CEO & Chairman at, <Link href="/">Araizona</Link>
                          </span>
                        </div>
                      </div>
                    </div>
