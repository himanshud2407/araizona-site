    ...
    <section className="testimonial pb-150 bg_img">
      <div className="container">
        <div className="sec-title sec-title-center tes-sec-title text-center mb-50">
          <span className="sub-title mb-15">What Our Clients Say</span>
          <h2 className="title">
            Trusted by Teams Who Demand
            <img src={((gifShape as any) as any).src || ((gifShape as any) as any)} alt="shape" /> More Than Software
          </h2>
        </div>
      </div>
                ...
                <div className="xb-item--inner xb-border">
                  ...
                  <div className="xb-item--author ul_li">
                    <div className="xb-item--avatar">
                      <img src={(item.avatar as any).src || (item.avatar as any)} alt={item.name} />
                    </div>
