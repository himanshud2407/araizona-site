              ...
              <div className="row mt-none-30">
                  ...
                  <div className="xb-feature-item xb-feature-item2">
                    <div className="xb-item--inner xb-border">
                      <span className="xb-item--icon">
                        <img src={(icon01 as any).src || icon01} alt="icon" />
                      </span>
                ...
                <div className="col-lg-6 col-md-6 mt-30">
                  <div className="xb-feature-item xb-feature-item2 xb-border">
                    <div className="xb-item--inner xb-border">
                      <span className="xb-item--icon">
                        <img src={(icon04 as any).src || icon04} alt="icon" />
                      </span>
                      <h2 className="xb-item--title">
                ...
                <div className="col-lg-6 col-md-6 mt-30">
                  <div className="xb-feature-item xb-feature-item2">
                    <div className="xb-item--inner xb-border">
                      <span className="xb-item--icon">
                        <img src={(icon02 as any).src || icon02} alt="icon" />
                      </span>
                      <h2 className="xb-item--title">
                ...
                <div className="col-lg-6 col-md-6 mt-30">
                  <div className="xb-feature-item xb-feature-item2 xb-border">
                    <div className="xb-item--inner xb-border">
                      <span className="xb-item--icon">
                        <img src={(icon06 as any).src || icon06} alt="icon" />
                      </span>
                      <h2 className="xb-item--title">
