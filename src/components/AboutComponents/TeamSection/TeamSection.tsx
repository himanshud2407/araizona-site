...
const TeamSection: React.FC = () => {
  return (
    <section
      ...
      style={{ backgroundImage: `url(${(bgTeam as any).src || bgTeam})` }}
    >
            ...
            >
              <div className="xb-team-item xb-border">
                <div className="xb-item--img">
                  <img src={(member.img as any).src || member.img} alt={member.name} />
                </div>
                ...
                <div className="xb-bg">
                  <img src={(noiseBg as any).src || noiseBg} alt="background texture" />
                </div>
              </div>
            </div>
          ))}
