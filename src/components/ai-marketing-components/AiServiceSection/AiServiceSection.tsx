        ...
        <div className="ai-service-wrap sec-border mlr-20">
          ...
          <div className="ai-service-heading ul_li_between mb-60 mt-40">
            <div className="sec-title-three">
              <span className="sub-title mb-25">Araizona SimpleSphere Products</span>
              <h2 className="title xb-text-reveal">
                Building intelligent business operating systems for organizations,
          ...
          <div className="ai-service-img">
            {[
              ...
              >
                <div className="img">
                  <img src={(item.img as any).src || (item.img as any)} alt={item.title} />
                </div>
