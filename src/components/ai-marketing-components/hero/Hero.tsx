      ...
      <div className="hero-style hero-style--three sec-border pos-rel">
        <div className="container-fluid">
          <div className="hero-content hero-content--three">
            ...
            >
              <h2 className="title">
                AI Marketing{" "}
                <img src={((gif1 as any) as any).src || ((gif1 as any) as any)} alt="animated gif" /> for Smarter Insights and
              </h2>
              ...
              <span className="hero-shape">
                <img src={((gif2 as any) as any).src || ((gif2 as any) as any)} alt="animated gif" />
              </span>
            </div>
        ...
        <div className="background_video">
          <video
            ...
            playsInline
            autoPlay
            poster={(heroPoster as any).src || heroPoster}
          ></video>
        </div>
      </div>
    </section>
