        ...
        <div className="mlr-20">
          <div className="ai-portfolio-wrap des-portfolio-wrap">
            ...
            <div className="ai-project-item des-portfolio-panel pos-rel not-hide-cursor mb-30" data-cursor="View<br>Demo">
              <Link className="cursor-hide" href="/project-details">
                <div className="ai-portfolio-thumb">
                  <img src={((img1 as any) as any).src || ((img1 as any) as any)} alt="GROK" />
                </div>
            ...
            <div className="ai-project-item des-portfolio-panel pos-rel not-hide-cursor mb-30" data-cursor="View<br>Demo">
              <Link className="cursor-hide" href="/project-details">
                <div className="ai-portfolio-thumb">
                  <img src={((img2 as any) as any).src || ((img2 as any) as any)} alt="Dummy Shoes Company" />
                </div>
            ...
            <div className="ai-project-item des-portfolio-panel pos-rel not-hide-cursor mb-30" data-cursor="View<br>Demo">
              <Link className="cursor-hide" href="/project-details">
                <div className="ai-portfolio-thumb">
                  <img src={((img3 as any) as any).src || ((img3 as any) as any)} alt="Perfume Brand" />
                </div>
            ...
            <div className="ai-project-item des-portfolio-panel pos-rel not-hide-cursor" data-cursor="View<br>Demo">
              <Link className="cursor-hide" href="/project-details">
                <div className="ai-portfolio-thumb">
                  <img src={((img4 as any) as any).src || ((img4 as any) as any)} alt="IBM" />
                </div>
