        ...
        <div className="ai-download-wrap ul_li_between mlr-20">
          ...
          >
            <div className="bg-shape">
              <img src={((netImg as any) as any).src || ((netImg as any) as any)} alt="background" />
            </div>
            ...
            <div className="ai-download-book">
              {bookList.map((book, index) => (
                ...
                >
                  <img src={(book.img as any).src || (book.img as any)} alt={`book ${index + 1}`} />
                </div>
              ))}
            </div>
              ...
              {bookList.map((book, index) => (
                ...
                >
                  <Link href="/service-details">
                    {book.title}
                    <img src={((downloadIcon as any) as any).src || ((downloadIcon as any) as any)} alt="icon" />
                  </Link>
                </li>
              ))}
            </ul>
