                                ...
                                (img, i) => (
                                    <SwiperSlide key={i}>
                                        <div className="ai-tes-img">
                                            <img src={((img as any) as any).src || ((img as any) as any)} alt={`testimonial-${i + 1}`} />
                                        </div>
                                    </SwiperSlide>
                                )
                            )}
                                    ...
                                    <div className="xb-item--inner">
                                        <div className="xb-item--content">
                                            <div className="xb-item--quote">
                                                <img src={((quoteIcon as any) as any).src || ((quoteIcon as any) as any)} alt="icon" />
                                            </div>
                                            ...
                                            <div className="xb-item--holder">
                                                ...
                                                <div className="xb-item--brand">
                                                    <img src={((brand01 as any) as any).src || ((brand01 as any) as any)} alt="logo" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="xb-item--inner">
                                        <div className="xb-item--content">
                                            ...
                                            <div className="xb-item--holder">
                                                ...
                                                <div className="xb-item--brand">
                                                    <img src={((brand02 as any) as any).src || ((brand02 as any) as any)} alt="logo" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="xb-item--inner">
                                        <div className="xb-item--content">
                                            ...
                                            <div className="xb-item--holder">
                                                ...
                                                <div className="xb-item--brand">
                                                    <img src={((brand03 as any) as any).src || ((brand03 as any) as any)} alt="logo" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="xb-item--inner">
                                        <div className="xb-item--content">
                                            ...
                                            <div className="xb-item--holder">
                                                ...
                                                <div className="xb-item--brand">
                                                    <img src={((brand04 as any) as any).src || ((brand04 as any) as any)} alt="logo" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
