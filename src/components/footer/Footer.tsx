...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      ...
      style={{ backgroundImage: `url(${(footerBg as any).src || footerBg})` }}
    >
      <div className="xb-footer-wrap">
        ...
        <div className="xb-footer-bottom">
          <div className="contact-item">
            <img src={(locationIcon as any).src || locationIcon} alt="location" />
            <span className="contact-method">S. No 80/3, Near Pune-Mumbai Bypass Highway, Talmulshi, Thathawade, Pune – 411033, Maharashtra</span>
          </div>

          <div className="contact-item copyright-item">
            <p>
              Copyright © 2025 <Link href="/">Araizona SimpleSphere Global Private Limited</Link>. All rights reserved. Pune, Maharashtra, India.
            </p>
          </div>

          <div className="contact-item">
            <a href="tel:+919322051181">
              <img src={(callIcon as any).src || callIcon} alt="call" />
            </a>
            <a className="contact-method" href="tel:+919322051181">
              +91 93220 51181 / +91 93595 58110
            </a>
          </div>
        </div>
      </div>
